...
A **column space** of a [[Matrix]] is a [[Span]] of its [[Column Vector|Column Vectors]]. 
The column space is also called the [[Rank]] of a matrix.
Let $K$ be a [[Field]] of [[Scalar|Scalars]]. Let $\mathbf{A}$ be an $m \times n$ matrix, with column vectors $\mathbf{v_1,v_2,...,v}_n$.
