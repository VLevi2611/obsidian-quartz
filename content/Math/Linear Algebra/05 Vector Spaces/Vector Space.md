...
\mathbf{u+(v+w)=(u+v)+w}
$$
2. [[Commutativity Of Addition]] for vectors: 
$$
\mathbf{u+v=v+u}
$$
3. [[Additive Identity]] for vectors: There [[Exists]] an [[Element Of]] the set $\mathbf{0} \in V$ called the [[Zero Vector]], such that 
$$
\mathbf{v+0=v}
$$
4. [[Additive Inverse]] for vectors: There exists an element of the set $-\mathbf{v} \in V$, such that 
$$
\mathbf{v+(-v)=0}
$$
