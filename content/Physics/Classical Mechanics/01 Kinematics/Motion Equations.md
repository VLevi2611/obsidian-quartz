...
The motion equations describes the differential relations between [[Displacement]], [[Velocity]] and [[Acceleration]].
...
$$
\begin{array}{l}
\mathbf{v}_1 = \frac{d\mathbf{x}_1}{dt} = \frac{5}{1} = 5 (\frac{m}{s}) \\
\mathbf{v}_2 = \frac{d\mathbf{x}_2}{dt} = \frac{10}{1} = 10 (\frac{m}{s}) \\
\mathbf{a} = \frac{d\mathbf{v}}{dt} = \frac{10-5}{1} = 5 (\frac{m}{s^2})
\end{array}
$$

## Notes

Positive velocity: going forwards
