...
**Blood vessels** are a network of hollow, tubular structures responsible for transporting blood throughout the entire body. Together with the heart and blood, they form the **Cardiovascular System**. This closed circulatory network supplies oxygen and vital nutrients to [[Tissue|Tissues]], removes metabolic waste products (like carbon dioxide), and facilitates hormonal and immune transport.

## Organization of the Vascular Network

The vascular system is a closed loop organized into three primary types of vessels, categorized by the direction of blood flow and structural properties:

### 1. Arteries and Arterioles

- **Arteries:** High-[[Pressure]] vessels that carry oxygenated blood _away_ from the heart to the rest of the body (with the exception of the pulmonary artery).
- **Arterioles:** Smaller branches of arteries that regulate blood pressure and control blood flow into capillary beds via smooth [[Muscle]] contraction.
...
With the exception of capillaries, the walls of blood vessels are organized into three distinct, concentric layers called **tunics**, surrounding a central blood-containing space called the **lumen**.
...
|---|---|---|---|
|**Lumen Size**|Relatively small, circular|Microscopic (fits one red blood cell)|Large, often collapsed/irregular|
|**Wall Thickness**|Thick (heavy tunica media)|Extremely thin (only tunica intima)|Thin (heavy tunica externa)|
|**Pressure**|High (80−120 mmHg)|Low (15−35 mmHg)|Lowest (2−5 mmHg)|
|**Valves**|Absent|Absent|Present (prevents backflow)|
