...
- **Abdominal Cavity:** Bounded superiorly by the diaphragm; it contains the stomach, liver, gallbladder, spleen, small intestine, and most of the large intestine.
- **Pelvic Cavity:** The lower portion, which contains the urinary bladder, terminal parts of the large intestine (rectum and anal canal), and internal reproductive organs.
...
- **Superior Regions:** Right and Left **Hypochondriac** (lateral) and the **Epigastric** (central).
- **Middle Regions:** Right and Left **Flank/Lumbar** (lateral) and the **Umbilical** (central).
- **Inferior Regions:** Right and Left **Groin/Inguinal** (lateral) and the **Pubic/Hypogastric** (central).
...
- **Peritoneal Recesses:** Specific clinical spaces where fluids can collect.
    - **Subphrenic Recess:** Separates the liver's diaphragmatic surface from the diaphragm.
    - **Hepatorenal Recess:** Located on the right side between the liver and the right kidney.
    - **Recto-uterine Pouch (Pouch of Douglas):** The lowest point of the abdominopelvic cavity in a supine woman, located between the uterus and rectum.