...
The **abdomen** is a roughly cylindrical chamber extending from the inferior margin of the [[03 Thorax|Thorax]] to the superior margin of the [[Pelvis]] and the [[02 Lower Limb|Lower Limb]]. It is a musculomembranous wall that houses and protects major elements of the gastrointestinal, urinary, and reproductive systems.

---

### [[Abdominal Anatomical Areas]]
...
- **Umbilical / Umbilicus:** Refers to the **navel** or belly button.
- **Lumbar:** Derived from the root for **loin**.
- **Hypochondrium:** Means **"under the cartilage,"** referring to the region inferior to the costal cartilages.
- **Epigastric:** Refers to the area **"upon the stomach"**.
...
- **Peritoneum:** The thin serous **membrane** lining the abdominal cavity.
- **Omentum:** A fatty peritoneal fold hanging like an **apron** over the viscera.
...
- **Xiphoid:** Means **"sword-like"** (the tip of the sternum).
- **Linea Alba:** Literally means **"white line,"** the midline tendon of the abdominal wall.
- **Linea Semilunaris:** Literally means **"half-moon line,"** the curved lateral border of the rectus abdominis.
- **Aponeurosis:** A large, **flat tendon** that anchors flat muscles to the skeleton or other muscles.