...
Imagine a [[System]] with constant [[Volume]], because of that no [[Work]] is done. 
$$
W = -P_{ext} \Delta V = 0
$$
If the [[Heat]] transferred for this constant volume process is denoted as $q_V$, than by the [[First Law of Thermodynamics]]: 
$$
\Delta U = q_V
$$
